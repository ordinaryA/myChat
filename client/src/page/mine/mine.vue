<template>
  <div class="com_layout mine_page">
      ...
      <mu-list-item>
        ...
        <mu-list-item-content>
          ...
          <mu-list-item-sub-title
            >Chat : {{ userInfo.username }}</mu-list-item-sub-title
          >
        </mu-list-item-content>
        <mu-list-item-action>
    ...
    <mu-list class="avaBox" v-for="(i, idx) in generalList" :key="idx">
      <mu-list-item button v-for="(item, n) in i" :key="n" :to="item.to">
    ...
    >
      <div class="ava_exsit">
        <mu-button slot="left" icon @click="closeAvatar">
      ...
      <div class="ava_con">
        <div class="ava_first cl">
          ...
          <div class="ava_one" v-for="(item, i) in avatarList" :key="i">
            <mu-avatar size="50" class="ava" @click="selectAvatar(i)">
              <img :src="item" />
            </mu-avatar>
          </div>
        </div>
